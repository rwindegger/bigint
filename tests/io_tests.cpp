...
namespace {
    TEST(bigint23, decimal_positive_os_test) {
        bigint23::bigint23<128, true> const a(123456789);
    ...
    TEST(bigint23, hex_unsigned_os_test) {
        bigint23::bigint23<128, false> const a(0x1A2B3C4D);
        std::ostringstream oss;
    ...
    TEST(bigint23, octal_unsigned_os_test) {
        bigint23::bigint23<128, false> const a(123456);
        std::ostringstream oss;
        oss << std::oct << a;
    ...
    TEST(bigint23, decimal_zero_os_test) {
        bigint23::bigint23<128, false> const a(0);
        std::ostringstream oss;
        oss << a;
        ASSERT_EQ(oss.str(), "0");
    }
